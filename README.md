...
## 🚀 Sobre mí
- 💼 Arquitecto móvil y fullstack, desarrollando plataformas internas críticas.
- 🧱 Especializado en arquitectura modular, desacoplamiento, Domain-Driven Design y patrones de flujo avanzado.
- 🔀 Experiencia construyendo monorepos multi-app con Melos, packages reutilizables y módulos compartidos.
- 🧪 Enfoque fuerte en calidad: testing, CI/CD, performance y estructura.
- 📡 Integración constante entre mobile, backend NestJS, Redis, Supabase y herramientas de infraestructura.
...
![Pinia](https://img.shields.io/badge/Pinia-FFC31F?style=for-the-badge&logo=vue.js&logoColor=white)
...
- **[Domain Events en Flutter: Comunicación desacoplada en un monorepo con Melos](https://medium.com/@edgardochiuchiolo/domain-events-en-flutter-comunicaci%C3%B3n-desacoplada-en-un-monorepo-con-melos-09379510b564)**  
  Explorando patrones avanzados para mantener features independientes y escalables.

- **[Arquitectura Limpia en Flutter: Construyendo un Monorepo Escalable con Domain Events](https://medium.com/@edgardochiuchiolo/arquitectura-limpia-en-flutter-construyendo-un-monorepo-escalable-con-domain-events-13aab34f4558)**  
  Guía práctica sobre cómo estructurar proyectos multi-app con Melos y Clean Architecture.
...
<p align="left">
  <a href="https://www.linkedin.com/in/edgardo-chiuchiolo/" target="_blank">
...
<div align="center">
  <i>"La arquitectura no es un lujo; es lo que permite que el código escale sin romperse."</i>
</div>
